...
public:
	...
	cthd_sysfs_cdev_rapl(unsigned int _index, std::string control_path, int package):
		cthd_sysfs_cdev(_index, control_path), package_id(package) {}
...
private:
	int logical_index;
public:
	cthd_sysfs_cdev_rapl_limited(unsigned int _logical_index, unsigned int _physical_index, std::string control_path, int package):
		cthd_sysfs_cdev_rapl(_physical_index, control_path, package) { logical_index = _logical_index; }
	int update()
	{
