...
void thd_logger( const gchar *log_domain,
...
//	gboolean use_thermal_sys_fs = FALSE;
	...
	g_option_context_set_summary (opt_ctx,
		_("Thermal monitors all temerature sensor and decide best action based on the temrature readings and user preferences."));
