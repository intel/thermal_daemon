...
public:
	...
	intel_pstate_driver_index(-1),intel_rapl_index_limited(-1), intel_rapl_driver_index(-1),
	...
	static const int intel_pstate_turbo_control_index = soft_cdev_start_index + 9;
