...
public:
	...
	int user_add_sensor(const std::string& name, const std::string& path);
	cthd_sensor *user_get_sensor(unsigned int index);
	cthd_zone *user_get_zone(unsigned int index);
	int user_add_virtual_sensor(const std::string& name, const std::string& dep_sensor,
	...
	int user_add_cdev(const std::string& cdev_name, const std::string& cdev_path,
